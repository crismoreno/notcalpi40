<template>
  <div class="home main-container mt-5">
    <div class="header-background">
      ...
      >
        <div
          class="description-desktop d-none d-md-flex d-lg-flex d-xl-flex flex-column"
        >
          <p>
            ...
            world.-->
            After noticing that the relationship between designers and
            developers is a struggle, I decided to shift gears and try
            developing end user interfaces all by myself. In spite of being
            comfortable in both Front-End and Back-End technologies, I consider
            myself a Front-End developer.
          ...
          <p>- Cristina Moreno -</p>
          <div>
            <router-link role="button" to="/about-me"
              >CHECKOUT MY CV</router-link
            >
          </div>
        </div>
        ...
        >
          <p>
            ...
            After noticing that the relationship between designers and
            developers is a struggle, I decided to shift gears and try
            developing end user interfaces by myself. In spite of being
            comfortable in both Front-End and Back-End technologies, I consider
            myself a Front-End developer.
            <!-- I'm highly motivated and committed to learning as much as I can! 💪 -->
            I’m highly motivated, willing to learn and eager to be challenged
            💪. Note that I’m ever so slightly OCD 🤏
          </p>
          <p>- Cristina Moreno -</p>
          <div>
            <router-link role="button" to="/about-me"
    ...
    <div
      class="container about-me-home d-flex flex-column flex-md-row flex-lg-row flex-xl-row"
    >
      ...
      <div class="about-me-detail d-flex flex-column">
        ...
        <p class="description-about-me">
          ...
          <br />
          I'm a {{ age }} years old Junior Front-End developer and designer
          based in Barcelona. <br />After finishing the degree (in design
          management) I was asked to manage several digital projects which made
          me notice that
          <span class="highlight">
            the relationship between designers and developers is a struggle
          </span>
          . It's been {{ bootcampAgo }} years since I decided to introduce
          myself into coding and after an
          <a href="https://www.ironhack.com/es/barcelona">Ironhack</a> bootcamp
          and a
          <a href="https://www.assemblerschool.com/"
            >Master degree at Assembler School</a
          >
          (and some work experience inbetween) here I'm! 🙋🏻‍♀.
          <span class="highlight"
            >I'm currently working at RedPoints as a Front-End developer where
            I'm improving my jS (React, Redux, React Testing Library &
            AntDesign) skills.</span
          >
          If you wanna know more about me, don't hesitate to
          <router-link to="/reach-me">reach out to me</router-link>.
        </p>
        <!-- <router-link class="link-to-cv" to="/about-me">FULL CV >></router-link> -->
        <div class="accordion" id="accordionExample">
          <div class="card">
            <div class="card-header" id="headingOne">
              <h2 class="mb-0">
                ...
                >
                  ...
                  <span
                    v-if="this.headingOne == 'closed'"
                    class="material-icons"
                    >add</span
                  >
                  <span
                    v-if="this.headingOne == 'opened'"
                    class="material-icons"
                    >close</span
                  >
                </button>
            ...
            >
              <div class="card-body">
                ...
                - Currently working on a backoffice area for this personal
                portfolio site. Get further info about it
                <router-link to="/project/71" style="text-decoration: underline"
                  >here</router-link
                >.<br />
                - Feeding my personal
                <a
                  ...
                  >blog</a
                ><br />
                - Will pick up next idea from
                <i style="line-height: unset">ideas checklist</i> after the
                backoffice feels like "done".
              </div>
            </div>
          </div>
          <div class="card">
            ...
            >
              <div class="card-body">
                I was born in June 1993, I'm <span class="mx-1">{{ age }}</span
                >years old.
              </div>
            </div>
          </div>
          <div class="card">
            ...
            >
              <div class="card-body">
                I was born in Sabadell but I'm currently based in Badalona,
                Barcelona.
              </div>
            </div>
          </div>
            ...
            >
              <div class="card-body">
                <p class="d-flex align-items-center my-0">
                  <span class="material-icons mr-1">call</span> +34 · 630 · 149
                  · 516
                </p>
                <div
                ...
                >
                  <span class="material-icons mr-1">accessibility_new</span
                  >Personality type:
                  <u>
                    <a
                      class="mx-1"
                  ...
                  <u>
                    <a
                      class="mx-1"
                      href="https://www.16personalities.com/esfj-personality"
                      >ESFJ-A / ESFJ-T</a
                    >
                  </u>
                </div>
                <ul>
                  <li class="d-flex align-items-center">
                    <span class="material-icons mr-1">code</span>Checkout my
                    <u class="mr-1 ml-1">
                      <a href="https://github.com/crismoreno">Github</a> </u
                    >profile
                  </li>
                  <li class="d-flex align-items-center">
                    <span class="material-icons mr-1">face</span>Checkout my
                    <u class="mr-1 ml-1">
                      <a href="https://www.linkedin.com/in/morenomedran/"
                        >Linkedin</a
                      >
                    </u>
                    profile
                  ...
                  <li class="d-flex align-items-center">
                    <span class="material-icons mr-1">create</span>Checkout my
                    <u class="mr-1 ml-1">
                      <a href="https://medium.com/@cristinamorenomedran"
                        >Medium</a
                      >
                    </u>
                    blog
                  ...
                  <li class="d-flex align-items-center">
                    <span class="material-icons mr-1">email</span>Reach out to
                    me!
                    <u class="mr-1 ml-1">
                  ...
                  <li class="mt-3">
                    <router-link class="link-to-cv" to="about-me"
                      >Checkout my CV</router-link
                    >
                  </li>
                </ul>
