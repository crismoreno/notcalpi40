    ...
    <div class="header-background">
      ...
      >
        <div class="description-desktop d-none d-md-flex d-lg-flex d-xl-flex flex-column">
          <p>
            No, this is not Calpi. This website is a tribute to my dad, who wanted to name me Calpèrnia when I was born.
            Lucky me, he changed his mind at the very last moment and finally both my parents agreed on calling me Cristina. I assume that if you've read this far is because you were curious about this website's name. So now, let's get down to business. Welcome to my online portfolio, welcome to my world.
          </p>
          <p>- Cristina Moreno -</p>
          <div>
            <a
    ...
    <div class="container about-me-home d-flex flex-column flex-md-row flex-lg-row flex-xl-row">
      ...
      <div class="about-me-detail d-flex flex-column">
        ...
        <p class="description-about-me">
          ...
          <br />I'm a Junior Front-End developer and designer based in Barcelona and looking for inspiration!
          <br />After finishing the degree (in design management) I was asked to manage several digital projects which made me notice
          that
          <span
            class="highlight"
          >the relationship between designers and developers is a struggle</span>. This fact pushed me to try developing end user interfaces by myself.
          After some research, I decided to take the plunge and go for the
          <a
            href="https://medium.com/@cristinamorenomedran/wallapop-scholarship-for-ironhack-88aa5d9afa3c"
            target_="blank"
          >Wallapop scholarship at Ironhack</a> and guess what...! I did it!
          <span
            class="highlight"
          >Being that my entrance ticket to coding.</span>
          <span
            class="highlight"
          >I'm very very motivated and committed to learning as much as I can! 💪</span>
        </p>
